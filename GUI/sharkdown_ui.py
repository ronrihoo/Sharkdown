...
class Ui_Sharkdown(object):
    def setupUi(self, Sharkdown):
        ...
        self.actionEditor = QtGui.QAction(Sharkdown)
    ...
    def retranslateUi(self, Sharkdown):
        ...
        self.actionEditor.setText(_translate("Sharkdown", "Editor Only", None))
        self.actionEditor.setShortcut(_translate("Sharkdown", "Ctrl+2", None))
